 ...
 *
 * This class is part of the LibGDX framework, source: https://libgdx.com/
 *
 * @author Inferno
 * @author davebaol
 * @since 1.0
 * */
public class GdxRandomXS128 extends Random {
	...
	public GdxRandomXS128() {
		setSeed(new Random().nextLong());
	}

	/** Creates a new random number generator using a single {@code long} seed.
	 * @param seed the initial seed */
	public GdxRandomXS128(long seed) {
		setSeed(seed);
	}
	...
	public GdxRandomXS128(long seed0, long seed1) {
